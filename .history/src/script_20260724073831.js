...
}else if(age is between 12 and 18){
...
}else (age >18){alert(`Hi ${name}, you are ${age} years old and you can register for any option of your choice. We will keep in touch via your email: ${email} 👋👋`)
